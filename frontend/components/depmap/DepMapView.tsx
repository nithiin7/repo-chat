...
export default function DepMapView({ repo, repoId }: DepMapViewProps) {
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-background text-foreground">
      ...
      {/* Search bar */}
      <div className="shrink-0 border-b border-border bg-background/90 px-4 py-2.5 backdrop-blur-md">
        <div className="mx-auto flex max-w-3xl items-center gap-2">
          ...
          />
          {filter && (
            <button onClick={() => setFilter('')} className="shrink-0 text-muted-foreground hover:text-foreground transition-colors">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="relative flex-1 overflow-hidden">
          ...
          {data && data.nodes.length === 0 && !isFetching && (
            <div className="absolute inset-0 flex items-center justify-center">
              <p className="text-sm text-muted-foreground">No import dependencies found in this repo.</p>
            </div>
          )}
            ...
            {data && positions && (
              <g transform={`translate(${pan.x}, ${pan.y}) scale(${scale})`}>
                ...
                {data.nodes.map(n => {
                  ...
                  const hasDimCause = (selected !== null && !isSelected && !isNeighbor)
          ...
          {/* Legend */}
          {data && positions && (
            <div className="absolute bottom-4 left-4 flex flex-col gap-1 rounded-xl border border-border bg-card/80 p-3 backdrop-blur-md">
          ...
          {/* Zoom hint */}
          {data && positions && (
            <div className="absolute bottom-4 right-4 text-[10px] text-muted-foreground/50 select-none">
