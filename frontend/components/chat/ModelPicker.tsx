...
const CLOUD_MODELS: Record<CloudProvider, ModelOption[]> = {
  anthropic: [
    { value: 'claude-opus-4-5', label: 'Most capable' },
    { value: 'claude-sonnet-4-5', label: 'Balanced' },
    { value: 'claude-haiku-4-5', label: 'Fast & efficient' },
    { value: 'claude-3-5-sonnet-20241022', label: 'Previous gen' },
    { value: 'claude-3-5-haiku-20241022', label: 'Previous gen, fast' },
    { value: 'claude-3-opus-20240229', label: 'Legacy' },
    { value: 'claude-3-haiku-20240307', label: 'Legacy, fast' },
  ],
  openai: [
    { value: 'gpt-4o', label: 'Latest, most capable' },
    { value: 'gpt-4o-mini', label: 'Fast & affordable' },
    { value: 'o3-mini', label: 'Advanced reasoning' },
    { value: 'o1', label: 'Reasoning' },
    { value: 'o1-mini', label: 'Reasoning, fast' },
    { value: 'gpt-4-turbo', label: 'Previous generation' },
    { value: 'gpt-3.5-turbo', label: 'Legacy' },
  ],
  groq: [
  ...
  gemini: [
    { value: 'gemini-2.5-pro', label: 'Most capable' },
    { value: 'gemini-2.5-flash', label: 'Fast & efficient' },
    { value: 'gemini-2.0-flash', label: 'Previous gen' },
    { value: 'gemini-1.5-pro', label: 'Legacy' },
    { value: 'gemini-1.5-flash', label: 'Legacy, fast' },
  ],
}
