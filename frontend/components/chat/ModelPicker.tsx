  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        className={cn(
          "border-border bg-card text-muted-foreground hover:bg-muted hover:text-foreground flex cursor-pointer items-center gap-1 rounded-md border px-2.5 py-1.5 text-xs transition-colors",
